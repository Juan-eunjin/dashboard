...
public class JiraApiService {
    ...
    public void fetchAndSaveJiraIssues() {
        ...
        headers.setBasicAuth("eunjinshin97@gmail.com", apiToken);
        HttpEntity<String> entity = new HttpEntity<>(headers);

        // 2. Jira REST API 호출 (최근 수정된 이슈들 가져오기)
        String url = jiraUrl + "/rest/api/3/search/jql?jql=project='KAN'&fields=status,created,duedate,summary,assignee,project"; // 최근 24시간 내 수정본
